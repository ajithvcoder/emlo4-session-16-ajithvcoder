...
def generate_image(prompt: str, output_path: str = "output.jpg"):
    ...
    url = "http://k8s-istioing-istioing-2d05f1be8c-32c6c491452ba8d2.elb.ap-south-1.amazonaws.com/v1/models/sd3:predict"
...
def list_models():
    base_url = "k8s-istioing-istioing-2d05f1be8c-32c6c491452ba8d2.elb.ap-south-1.amazonaws.com"
    headers = {
        "Host": "torchserve-sd3-default.example.com",
    }
